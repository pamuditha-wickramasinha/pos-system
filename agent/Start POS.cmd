...
REM  Address of the POS. Change this to your server.
set "POS_URL=http://76.13.247.65/pos"

REM  Must match PRINT_AGENT_PORT on the server (default 9110).
set "AGENT_PORT=9110"
...
powershell -ExecutionPolicy Bypass -NoProfile -File "%~dp0start-pos.ps1" -Url "%POS_URL%" -Port %AGENT_PORT% %KIOSK_FLAG%

        ...
        try {
            ...
            for ($i = 1; $i <= $rowCount; $i++) {
                ...
                PurchaseItem::create([
                    ...
                    'purchase_status' => $request->input('purchase_status'),
                    'item_id' => $itemId,
                    'purchase_qty' => $request->input("td_data_{$i}_3") ?: 0,
                    'price_per_unit' => $request->input("td_data_{$i}_4") ?: 0,
                    'tax_id' => $request->input("tr_tax_id_{$i}") ?: null,
                    'tax_amt' => $request->input("td_data_{$i}_5") ?: null,
                    'tax_type' => $request->input("tr_tax_type_{$i}"),
                    'unit_total_cost' => $request->input("td_data_{$i}_10") ?: 0,
                    'total_cost' => $request->input("td_data_{$i}_9") ?: 0,
                    'status' => true,

...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('purchase_items_returns', function (Blueprint $table) {
            $table->id();
            $table->foreignId('purchase_id')->nullable()->constrained('purchases')->nullOnDelete();
        ...
        Schema::create('purchase_payments_returns', function (Blueprint $table) {
            $table->id();
            $table->foreignId('purchase_id')->nullable()->constrained('purchases')->nullOnDelete();
            $table->foreignId('return_id')->constrained('purchase_returns')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('purchase_payments_returns');
        Schema::dropIfExists('purchase_items_returns');

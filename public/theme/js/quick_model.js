        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result == "success") {
                    ...
                    get_details()
                    // reset_item_search also clears the term jQuery UI remembers,
                    // so the barcode just added can be scanned again straight away
                    if (typeof reset_item_search === 'function') {
                        reset_item_search()
                    } else {
                        $('#item_search').val('')
                    }

                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control select2" id="category_id" name="category_id" style="width: 100%;">
                                    ...
                                    @foreach (\App\Models\ExpenseCategory::where('status', true)->get() as $c)
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-bordered table-hover" id="report-data">
                        <thead>
                        <tr class="bg-blue">
                            <th>#</th><th>Expense Code</th><th>Expense Date</th><th>Category</th><th>Reference No</th><th>Expense For</th><th>Amount</th><th>Note</th><th>Created By</th>
                        </tr>
                        </thead>
...
<script src="{{ $theme_link }}js/report-expense.js"></script>
<script>
$(".select2").select2();

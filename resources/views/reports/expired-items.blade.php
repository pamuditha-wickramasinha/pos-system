@extends('layouts.app')
@php($activeMenu = 'report-expired-items')
                ...
                <form class="form-horizontal" id="report-form" onkeypress="return event.keyCode != 13;">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <label for="to_date" class="col-sm-2 control-label">Expire Before</label>
                            <div class="col-sm-3">
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-bordered table-hover" id="report-data">
                        <thead>
                        <tr class="bg-blue">
                            <th>#</th><th>Item Code</th><th>Item Name</th><th>Lot Number</th><th>Expire Date</th><th>Stock</th>
                        </tr>
                        </thead>
...
<script src="{{ $theme_link }}js/report-expired-items.js"></script>

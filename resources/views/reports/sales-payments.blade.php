@extends('layouts.app')
@php($activeMenu = 'report-sales-payments')
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab_1" data-toggle="tab">Sales Payments</a></li>
                    <li><a href="#tab_2" data-toggle="tab">Customer Payments</a></li>
                </ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="report-data-1">
                                    <thead>
                                    <tr class="bg-blue">
                                        <th>#</th><th>Sales<br>Invoice No</th><th>Payment Date</th><th>Customer Code</th><th>Customer Name</th><th>Payment Type</th><th>Payment Note</th><th>Paid Amount({{ currency() }})</th><th>Created By</th>
                                    </tr>
                                    </thead>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="report-data-2">
                                    <thead>
                                    <tr class="bg-blue">
                                        <th>#</th><th>Payment Date</th><th>Customer Name</th><th>Payment Type</th><th>Payment Note</th><th>Paid Amount({{ currency() }})</th><th>Created By</th>
                                    </tr>
                                    </thead>
                                    <tbody></tbody>
                                </table>

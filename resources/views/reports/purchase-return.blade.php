@extends('layouts.app')
@php($activeMenu = 'report-purchase-return')
                ...
                <form class="form-horizontal" id="report-form" onkeypress="return event.keyCode != 13;">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control select2" id="supplier_id" name="supplier_id"></select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-bordered table-hover" id="report-data">
                        <thead>
                        <tr class="bg-blue">
                            <th>#</th><th>Invoice No</th><th>Return Date</th><th>Purchase Code</th><th>Supplier Name</th>
                            <th>Invoice Total({{ currency() }})</th><th>Paid Amount({{ currency() }})</th><th>Due Amount({{ currency() }})</th>
                        </tr>
                        </thead>
...
<script src="{{ $theme_link }}js/report-purchase-report.js"></script>

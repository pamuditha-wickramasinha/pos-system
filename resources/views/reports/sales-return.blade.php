@extends('layouts.app')
@php($activeMenu = 'report-sales-return')
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-bordered table-hover" id="report-data">
                        <thead>
                        <tr class="bg-blue">
                            <th>#</th><th>Invoice No</th><th>Return Date</th><th>Sales Code</th><th>Customer Name</th>
...
<script src="{{ $theme_link }}js/report-sales-return.js"></script>

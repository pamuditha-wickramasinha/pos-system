@extends('layouts.app')
@php($activeMenu = 'report-purchase')
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-bordered table-hover" id="report-data">
                        <thead>
                        <tr class="bg-blue">
                            <th>#</th><th>Invoice No</th><th>Purchase Date</th><th>Supplier Code</th><th>Supplier Name</th>
...
<script src="{{ $theme_link }}js/report-purchase.js"></script>

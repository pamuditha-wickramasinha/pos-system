...
<section class="content-header">
    <h1>{{ $page_title }} <small>View/Search Items Category</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a class="btn btn-block btn-info" href="{{ route('category.add') }}">

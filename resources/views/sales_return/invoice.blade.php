@extends('layouts.app')
@php($activeMenu = 'sales_return')

@section('content')
<section class="content-header">
    <h1>Invoice <small>Sales Return Invoice</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body">
                    <div class="row invoice-info">
                        <div class="col-sm-4">
                            <h4>Customer</h4>
                            <address>
                                {{ $returnEntry->customer->customer_name }}<br>
                                {{ $returnEntry->customer->mobile }}<br>
                                {{ $returnEntry->customer->address }}
                            </address>
                        </div>
                        <div class="col-sm-4">
                            <h4>Return Info</h4>
                    ...
                    <a class="btn btn-info" target="_blank" href="{{ route('sales_return.print_invoice', $returnEntry) }}"><i class="fa fa-print"></i> Print</a>
                    <a class="btn btn-danger" target="_blank" href="{{ route('sales_return.pdf', $returnEntry) }}"><i class="fa fa-file-pdf-o"></i> PDF</a>
                    <a class="btn btn-default" href="{{ route('sales_return.index') }}">Back</a>
                </div>
            </div>
        </div>
    </div>

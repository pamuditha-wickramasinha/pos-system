    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="col-md-12">
                        <div class="row invoice-info">
                            <div class="col-sm-4 invoice-col">
                                ...
                                <address>
                                    <strong>{{ $returnEntry->customer->customer_name }}</strong><br>
                                    @if($returnEntry->customer->mobile)Mobile: {{ $returnEntry->customer->mobile }}<br>@endif
                                    @if($returnEntry->customer->email)Email: {{ $returnEntry->customer->email }}<br>@endif
                                </address>
                            </div>
                            <div class="col-sm-4 invoice-col">
                                Sales Information:
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="save_payment({{ $returnEntry->id }})" class="btn bg-green btn-lg place_order btn-lg payment_save">Save<i class="fa  fa-check "></i></button>
            </div>
        </div>
    </div>
</div>

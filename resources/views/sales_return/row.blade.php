...
<tr id="row_{{ $rowcount }}" data-row="{{ $rowcount }}">
    ...
    <td id="td_{{ $rowcount }}_12" class="{{ tax_disable_class() }}">
        <label class="form-control" style="width:100%;padding-left:0px;padding-right:0px;">
            <a id="td_data_{{ $rowcount }}_12" href="javascript:void(0)" data-toggle="tooltip" title="Click to Change" onclick="show_sales_item_modal({{ $rowcount }})">{{ $item->tax?->tax_name }}</a>
        </label>
    </td>
    ...
    <input type="hidden" id="purchase_price_{{ $rowcount }}" name="purchase_price_{{ $rowcount }}" value="{{ $purchasePrice }}">
</tr>

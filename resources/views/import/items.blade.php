                ...
                <form class="form-horizontal" id="import-form" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="callout callout-info">
                            <h4>Column Order</h4>
                            <p>item_name, category, sku, hsn, unit, alert_qty, brand, expire_date, purchase_price, tax_name, tax_percent, tax_type(Inclusive/Exclusive), sales_price, stock, custom_barcode, discount_type, discount</p>
                        </div>

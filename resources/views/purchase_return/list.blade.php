@extends('layouts.app')
@php($activeMenu = 'purchase-returns-list')
...
<section class="content-header">
    <h1>{{ $page_title }} <small>View/Search Purchase Returns</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    @can('purchase_return_add')
                    <div class="box-tools">
                        <a class="btn btn-block btn-info" href="{{ route('purchase_return.create') }}"><i class="fa fa-plus"></i> New Purchase Return</a>
                    </div>
                    @endcan
                </div>
                <div class="box-body">
...
$(document).ready(function() {
    var table = $('#example2').DataTable({
        ...
        ajax: {
            url: "{{ route('purchase_return.ajax_list') }}", type: "POST",
        ...
        columns: [
            ...
            { data: 'purchase_code', name: 'purchase_code', orderable: false },

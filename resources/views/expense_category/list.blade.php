@extends('layouts.app')
@php($activeMenu = 'expense-category-list')
...
<section class="content-header">
    <h1>{{ $page_title }} <small>View/Search Expense Category</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a class="btn btn-block btn-info" href="{{ route('expense.category_add') }}">
                            <i class="fa fa-plus"></i> New Expense Category</a>
                    </div>
                    @endcan
                </div>
                <div class="box-body">
...
$(document).ready(function() {
    var table = $('#example2').DataTable({
        ...
        ajax: {
            url: "{{ route('expense.category_ajax_list') }}",
            type: "POST",
...
<script src="{{ $theme_link }}js/expense_category.js"></script>
@endpush

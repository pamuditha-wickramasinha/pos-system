...
<section class="content-header">
    <h1>{{ $page_title }} <small>View/Search Currencies</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    @can('currency_add')
                    <div class="box-tools">
                        <a class="btn btn-block btn-info" href="{{ route('currency.add') }}"><i class="fa fa-plus"></i> New Currency</a>
                    </div>
                    @endcan
                </div>
                <div class="box-body">
...
$(document).ready(function() {
    var table = $('#example2').DataTable({
        ...
        ajax: {
            url: "{{ route('currency.ajax_list') }}", type: "POST",

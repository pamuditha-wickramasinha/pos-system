...
<section class="content-header">
    <h1>{{ $page_title }} <small>View/Search Expenses</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    @can('expense_add')
                    <div class="box-tools">
                        <a class="btn btn-block btn-info" href="{{ route('expense.add') }}"><i class="fa fa-plus"></i> New Expense</a>
                    </div>
                    @endcan
                </div>
                <div class="box-body">
...
$(document).ready(function() {
    var table = $('#example2').DataTable({
        ...
        columns: [
            ...
            { data: 'expense_amt', name: 'expense_amt' },
            { data: 'note', name: 'note' },

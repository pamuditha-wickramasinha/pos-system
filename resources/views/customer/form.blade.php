@extends('layouts.app')
@php($activeMenu = 'customers')

@section('content')
<section class="content-header">
    <h1>{{ $page_title }} <small>Add/Update Customers</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <form class="form-horizontal" id="customers-form" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="customer_name" name="customer_name" value="{{ $customer_name ?? '' }}" autofocus>
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                        @php($payments = isset($q_id) ? \App\Models\CustomerOpeningBalancePayment::where('customer_id', $q_id)->get() : collect())

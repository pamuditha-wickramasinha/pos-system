    ...
    <div class="modal-dialog">
        <div class="modal-content">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-12 invoice-col">
                                <table class="table table-sm table-bordered bg-info" width="100%">
                                    <tr><td class="text-right">Total Sales Amount</td><td class="text-right">{{ currency($totalSalesAmount) }}</td></tr>
                                    ...
                                    <tr><td class="text-right">Sales Due</td><td class="text-right">{{ currency($customer->sales_due) }}</td></tr>
                                </table>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="save_payment({{ $customer->id }})" class="btn bg-green btn-lg place_order btn-lg payment_save">Save<i class="fa  fa-check "></i></button>
            </div>
        </div>
    </div>
</div>

@extends('layouts.app')
@php($activeMenu = 'payment_types')

@section('content')
<section class="content-header">
    <h1>{{ $page_title }} <small>Add/Update Payment Type</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ url('dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ route('payment_types.index') }}">Payment Types List</a></li>
                ...
                <form class="form-horizontal" id="payment-types-form" onkeypress="return event.keyCode != 13;">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label for="payment_type_name" class="col-sm-2 control-label">Payment Type Name<label class="text-danger">*</label></label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control input-sm" id="payment_type_name" name="payment_type_name" value="{{ $payment_type_name ?? '' }}" autofocus onkeyup="shift_cursor(event,'save')">
                    ...
                    <div class="box-footer">
                        <div class="col-sm-8 col-sm-offset-2 text-center">
                            @if (! empty($payment_type_name) && isset($q_id))

@extends('layouts.app')
@php($activeMenu = 'country')

@section('content')
<section class="content-header">
    <h1>{{ $page_title }} <small>Add/Update Country</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ url('dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ route('country.index') }}">Countries List</a></li>
                ...
                <form class="form-horizontal" id="country-form" onkeypress="return event.keyCode != 13;">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control input-sm" id="country_name" name="country_name" value="{{ $country ?? '' }}" autofocus onkeyup="shift_cursor(event,'save')">
...
@push('scripts')
<script src="{{ $theme_link }}js/country.js"></script>
@endpush

...
<section class="content-header">
    <h1>{{ $page_title }} <small>View/Search Brands</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    @can('brand_add')
                    <div class="box-tools">
                        <a class="btn btn-block btn-info" href="{{ route('brands.add') }}"><i class="fa fa-plus"></i> New Brand</a>
                    </div>
                    @endcan
                </div>
                <div class="box-body">
...
$(document).ready(function() {
    var table = $('#example2').DataTable({
        ...
        ajax: {
            url: "{{ route('brands.ajax_list') }}", type: "POST",

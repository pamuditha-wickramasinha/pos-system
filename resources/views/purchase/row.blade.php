...
<tr id="row_{{ $rowcount }}" data-row="{{ $rowcount }}">
    ...
    <td id="td_{{ $rowcount }}_3">
        <div class="input-group ">
            ...
            <input type="text" value="{{ $qty }}" class="form-control no-padding text-center" onkeyup="calculate_tax({{ $rowcount }})" id="td_data_{{ $rowcount }}_3" name="td_data_{{ $rowcount }}_3">
    ...
    <td id="td_{{ $rowcount }}_8">
        <input type="text" data-toggle="tooltip" title="Click to Change" name="td_data_{{ $rowcount }}_8" id="td_data_{{ $rowcount }}_8" class="form-control pointer text-right no-padding only_currency text-center item_discount" value="{{ $discount }}" onclick="show_purchase_item_modal({{ $rowcount }})" readonly>
    </td>
    <td id="td_{{ $rowcount }}_15" class="{{ tax_disable_class() }}">
        <label class="form-control"><a id="td_data_{{ $rowcount }}_15" data-toggle="tooltip" title="Click to Change" class="pointer" onclick="show_purchase_item_modal({{ $rowcount }})">{{ $tax->tax_name ?? '' }}</a></label>
    </td>
    ...
    <td id="td_{{ $rowcount }}_9"><input type="text" name="td_data_{{ $rowcount }}_9" id="td_data_{{ $rowcount }}_9" class="form-control text-right no-padding only_currency text-center" style="border-color: #f39c12;" title="Total" readonly value="{{ $itemAmount }}"></td>

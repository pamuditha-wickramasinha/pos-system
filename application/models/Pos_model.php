...
class Pos_model extends CI_Model {
	...
	public function get_details(){
		...
		extract($_POST);
		  ...
		  if(!empty($item_name)){
		  	$this->db->where("upper(a.item_name) like upper('%".$item_name."%') or upper(a.item_sing_name) like upper('%".$item_name."%')");
		  }
		  $this->db->limit(30);
		  //echo $this->db->get_compiled_select();exit();
		  $q2=$this->db->get();
	      ...
	      if($q2->num_rows()>0){
	        foreach($q2->result() as $res2){
	        	...
	        	$item_sales_real_price = $res2->sales_price - $res2->discount;
	        	$item_wholesale_sales_real_price = $res2->sales_price - $res2->wholesale_discount;
	        	...
	        	$wholesale_discount = $res2->wholesale_discount;
	        	$item_sales_qty = 1;
	          ...
	          <div class="box box-default item_box" id="div_'.$res2->id.'" onclick="'.$str.'"
	          				...
	          				data-wholesale_discount="'.$wholesale_discount.'"
	           				style="max-height: 120px;min-height: 120px;cursor: pointer;'.$bg_color.'">
	            ...
	            <div class="box-body box-profile">
	              ...
	              <span class="" style="font-family: sans-serif;font-size:100%; " >'.$CI->currency(app_number_format($item_sales_real_price)).'
	              </span>
				  <p class="" style="font-family: sans-serif; font-size:80%" >'.$CI->currency(app_number_format($item_wholesale_sales_real_price)).'
	              </p>
	            </div>
	          </div>
	        </div>';

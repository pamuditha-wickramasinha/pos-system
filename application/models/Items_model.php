...
class Items_model extends CI_Model {
	...
	public function verify_and_save(){
		...
		$query1="insert into db_items(description,item_code,item_sing_name,item_name,brand_id,category_id,sku,hsn,unit_id,alert_qty,lot_number,expire_date,
									price,tax_id,purchase_price,tax_type,profit_margin,
									sales_price,custom_barcode,final_price,
									system_ip,system_name,created_date,created_time,created_by,status,discount_type,discount,wholesale_discount)

							values('$description','$item_code','$item_sing_name','$item_name','$brand_id','$category_id','$sku','$hsn','$unit_id','$alert_qty','$lot_number','$expire_date',
									'$price','$tax_id','$purchase_price','$tax_type',$profit_margin,
									'$sales_price','$custom_barcode','$final_price',
									'$SYSTEM_IP','$SYSTEM_NAME','$CUR_DATE','$CUR_TIME','$CUR_USERNAME',1,'$discount_type','$discount', '$wholesale_discount')";

...
<body>
    ...
    <table width="98%" align="center">
        <tr>
            <td align="center">
                <span>
                    <strong style="font-size: 25px;"><?= $company_name; ?></strong><br>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tbody style="border-bottom-style: dashed;border-width: 0.1px;">
                        <?php
			              ...
			              foreach ($q2->result() as $res2) {
			                  ...
			                  echo "<td style='text-align: right;padding-left: 2px; padding-right: 2px;'>".number_format((($res2->price_per_unit)-($res2->discount_amt/$res2->sales_qty)),2,'.','')."</td>";
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td style=" padding-left: 2px; padding-right: 2px;" align="right">
                                <?= number_format($change_return_amount,2,'.',''); ?></td>
                        </tr>
                        <?php }
					else{ ?>
                        <tr>
                            <td style=" padding-left: 2px; padding-right: 2px;" colspan="5" align="right">
                                <?= $this->lang->line('paid_amount'); ?></td>
                            <td style=" padding-left: 2px; padding-right: 2px;" align="right">
    ...
    <div style="text-align:center">
        ...
        <b>-----------------------------------------</b>
        <br />
        <b><i><?= $sales_invoice_footer_text; ?></i></b>
        ...
        <div class="row no-print">
            <div class="col-md-12">
                <div class="col-md-2 col-md-offset-5 col-xs-4 col-xs-offset-4 form-group">
                    <button type="button" id="" class="btn btn-block btn-success btn-xs" onclick="printOnly();"

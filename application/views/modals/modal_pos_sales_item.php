                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 <?=tax_disable_class()?>">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="popup_tax_type"
                                                            name="popup_tax_id" style="width: 100%;">
                                                ...
                                                <div class="col-md-6 <?=tax_disable_class()?>">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="popup_tax_id"
                                                            name="popup_tax_id" style="width: 100%;">
                                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="item_discount_type"><?= $this->lang->line('discount_type'); ?></label>
                                                        <select class="form-control" id="item_discount_type"
                                                            name="item_discount_type" style="width: 100%;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label
                                                            for="item_discount_input"><?= $this->lang->line('discount'); ?></label>
                                                        <input type="text" class="form-control only_currency"
                                                            id="item_discount_input" name="item_discount_input"
                                                            placeholder="" value="0">
                                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label
                                                            for="popup_tax_type"><?= $this->lang->line('description'); ?></label>
                                                        <textarea type="text" class="form-control"
                                                            id="popup_description" placeholder=""></textarea>
                                                    </div>

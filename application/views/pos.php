...
<body class="hold-transition skin-blue layout-top-nav">
            ...
            <nav class="navbar navbar-static-top">
                <div class="container">
                    <div class="navbar-header">
                        <a href="<?php echo $base_url; ?>dashboard" class="navbar-brand" title="Go to Dashboard!"><b
                                class="hidden-xs"><?php  echo $SITE_TITLE;?></b><b class="hidden-lg">POS</b></a>
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class=""><a href="<?php echo $base_url; ?>sales" title="View Sales List!"><i
                                        class="fa fa-list text-yellow"></i>
                                    <span><?= $this->lang->line('sales_list'); ?></span></a></li>
                            <?php } ?>
                            <?php if($CI->permissions('sales_add')) { ?>
                            <li class=""><a href="<?php echo $base_url; ?>pos" title="Create New POS Invoice"><i
                                        class="fa fa-calculator text-yellow "></i>
                                    <span><?= $this->lang->line('new_invoice'); ?></span></a></li>
                            <?php } ?>
                            <?php if($CI->permissions('items_view')) { ?>
                            <li class=""><a href="<?php echo $base_url; ?>items/" title="View Items List"><i
                                        class="fa  fa-cubes text-yellow "></i>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="text-center" id="">
                                <a title="Dashboard" href="<?php echo $base_url; ?>dashboard"><i
                                        class="fa fa-dashboard text-yellow"></i><b
                                        class="hidden-xs"><?= $this->lang->line('dashboard'); ?></b></a>
                            </li>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span
                                        class="hidden-xs"><?php print ucfirst($this->session->userdata('inv_username')); ?></span>
                                </a>

                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="<?php echo get_profile_picture(); ?>" class="img-circle"
                                            alt="User Image">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4 pull-right">
                                                <a href='<?= $base_url;?>pos' class="btn btn-primary pull-right">New
                                                    Invoice</a>
                                            </div>
                                            <?php } ?>
                                            <?php endif; ?>
                                                        ...
                                                        <div class="box-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="" value="<?=$discount_input?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="col-sm-12"
                                                    style="overflow-y:auto;border:1px solid #337ab7;">
                                                    <table
                    ...
                    ?>
                                        ...
                                        <div class="col-xs-12 ">
                                            <div class="col-md-6">
                                                <!-- <div class="checkbox icheck">
                                                    <input type="checkbox" <?=$send_sms_checkbox;?> class="form-control"
                                                        id="send_sms" name="send_sms"> <label for="sales_discount"
                                                        class=" control-label"><label
                                                            for='send_sms'><?= $this->lang->line('send_sms_to_customer'); ?></label>
                                                        <i class="hover-q " data-container="body" data-toggle="popover"
                                                            ...
                                                            title="Do you wants to send SMS ?">
                                                            <i
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="other_charges"
                                                        class="col-sm-7 control-label"><?= $this->lang->line('other_charges'); ?><label
                                                            class="text-danger">*</label></label>

                                                    <div class="col-sm-5">
                                                        <input type="text" class="form-control text-right"
                                                            id="other_charges" name="other_charges" placeholder="0.00"
                                                            value="<?=$other_charges?>">
                                                        <span id="other_charges_msg" style="display:none"
                                ...
                                <div class="box-footer bg-gray">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-right">
                                            <label><?= $this->lang->line('total_discount'); ?>:<a
                                                    class="fa fa-pencil-square-o cursor-pointer" data-toggle="modal"
                                                    data-target="#discount-modal"></a></label><br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            ...
                                            <div class="col-sm-3">
                                                <button type="button" id="hold_invoice" name=""
                                            ...
                                            <div class="col-sm-3">
                                                <button type="button" id="" name=""
                                                    class="btn btn-primary btn-block btn-flat btn-lg show_payments_modal"
                                            ...
                                            <div class="col-sm-3">
                                                <button type="button" id="<?php echo "show_cash_modal";?>" name=""
                                                    class="btn btn-success btn-block btn-flat btn-lg shift_c"
                                            ...
                                            <div class="col-sm-3">
                                                <button type="button" id="pay_all" name=""
                                                    class="btn bg-purple btn-block btn-flat btn-lg shift_a"
                    ...
                    <div class="col-md-5">
                      ...
                      ?>
                                            ...
                                            <span class="input-group-btn">
                                                <button type="button" class="btn text-blue btn-flat reset_categories"
                                                    title="Reset Brand" data-toggle="tooltip" data-placement="top">
                      ...
                      ?>
                                            ...
                                            <span class="input-group-btn">
                                                <button type="button" class="btn text-blue btn-flat reset_brands"
                                                    title="Reset Brand" data-toggle="tooltip" data-placement="top">
                                                    <i class="fa fa-undo"></i>
                                                </button>
                                            </span>
                                        ...
                                        <div class="input-group input-group-md">
                                            ...
                                            <span class="input-group-btn">
                                                <button type="button" class="btn text-blue btn-flat reset_item_name"
                                                    title="Reset Item Name" data-toggle="tooltip" data-placement="top">
                                                    <i class="fa fa-undo"></i>
                                                </button>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <section class="content">
                                            <div class="row search_div"
                                                style="overflow-y: scroll;min-height: 100px;height: 500px;">
                                            </div>
                                        </section>
    ...
    function addrow(id = '', item_obj = '') {
        ...
        quantity += '<input type="text" value="' + qty +
        ...
        str += '<td id="td_' + rowcount +
            '_0"><a class="pointer" id="td_data_' + rowcount +
            '_0">' + item_name +
            '</a></td>'; /* td_0_0 item name*/
        ...
        info = '<input id="sales_price_' + rowcount + '" onblur="set_to_original(' + rowcount + ',' + item_cost +
            ...
            '" type="text" class="form-control no-padding min_width" value="' + sales_price + '">';
        ...
        str += '<td id="td_' + rowcount +
            ...
            '_4" type="text" class="form-control no-padding pointer" readonly value="' + sub_total +
            '"></td>'; /* td_0_4 item sub_total */
    ...
    $(document).ready(function() {
        ...
        $(".search_div").parent().css("height", ((second_div - items_table) > 500) ? 500 : (second_div -
            items_table)); /**/
        ...
        // Set focus to item search input on page load
        $("#item_search").focus();
    }); //ready() end
    ...
    function get_item_details(item_id) {
        ...
        $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
        $.post("<?php echo $base_url; ?>pos/get_item_details", {
            item_id: item_id
        }, function(result) {
            //console.log(result);
                ...
                success: function(res) {
                    ...
                    if (res.length) {
                        ...
                        result = $.map(res, function(el) {
                            return {
                                label: el.item_code + '--[Qty:' + el.stock + '] --' + el
                                    .label,
                                value: '',
                                id: el.id,
                                item_name: el.value,
